	...
	$.fn.activiTag = function(opts) {
		opts = $.extend({
			...
			a_List: [
			         ...
			         "<a href='http://www.tmail.com'>&nbsp;天猫&nbsp; </a>",
			         "<a href='http://wh.ganji.com'>赶集网&nbsp;</a>",
			         "<a href='http://wh.58.com'>  &nbsp;58同城 &nbsp;</a>",
			         "<a href='http://www.dangdang.com'> &nbsp;当当&nbsp; </a>",
			         "<a href='http://www.uuu9.com'>&nbsp; &nbsp;悠久网  &nbsp;</a>",
			         "<a href='http://www.tuniu.com'> 途牛旅游</a>",
			         ],	// a标签字符串数组
			// 背景颜色数组
